<#
Wrapper that Task Scheduler runs to refresh the README "Channels Created" badge.
...
because update_channels_created_badge.py calls `docker` by name.

WHAT IT DOES. Runs scripts/update_channels_created_badge.py, appends a timestamped
...
Copied from the equivalent wrapper in the sibling IPTV Checker plugin. That
project's notes carry the same traps.
#>
...
$Script = Join-Path $PSScriptRoot 'update_channels_created_badge.py'
