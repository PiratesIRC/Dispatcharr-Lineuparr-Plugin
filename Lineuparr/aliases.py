...
CHANNEL_ALIASES = {
    ...
    "Sky Cinema SciFi/Horror": [
        "Sky ScFi/HorHD",
        "Sky Sci-Fi HD",
        "HEVC HD SKY CINEMA SCIFI/HORROR",
    ],
    "Sky Cinema Animation": [
        "Sky Cinema Animation HD",
        "HEVC HD SKY CINEMA ANIMATION",
        "SkyAnimationHD",
    ],
    # --- UK: Kids ---
...
COUNTRY_ALIASES = {
    ...
    "DO": {
        ...
        "CDN Sports Max": ["CDN Deportes", "CDN Sports", "CDN Deportes Max"],
        "CDN Sports Max HD": [
            "CDN Deportes HD",
            "CDN Sports HD",
            "CDN Deportes Max HD",
        ...
        "Color Vision HD": ["Colorvision HD", "Color Visión HD"],
